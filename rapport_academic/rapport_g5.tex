...
\begin{figure}[h!]
    \centering
    % Pour inclure l'image réelle plus tard : \includegraphics[width=0.85\textwidth]{images/aws_rds_console.png}
    \fbox{\parbox{0.85\textwidth}{\centering \vspace*{2cm} [Capture d'écran 1 : Console AWS RDS montrant l'instance PostgreSQL active et sécurisée en région eu-central-1] \vspace*{2cm}}}
    \caption{Visualisation de l'instance RDS PostgreSQL déployée sur AWS}
    \label{fig:aws_rds_console_main}
\end{figure}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.85\textwidth]{images/aws_s3_buckets_list.png}
    \fbox{\parbox{0.85\textwidth}{\centering \vspace*{2cm} [Capture d'écran 2 : Liste des buckets S3 créés dans la console AWS (11 principaux + 11 buckets de logs associés)] \vspace*{2cm}}}
    \caption{Liste des buckets S3 régionaux provisionnés pour les CDNUs}
    \label{fig:aws_s3_buckets_list_main}
\end{figure}
...
\begin{figure}[h!]
    ...
    \label{fig:aws_ecr_registry_main}
\end{figure}
...
\begin{figure}[h!]
    ...
    \label{fig:terminal_directory_tree_main}
\end{figure}
...
\begin{figure}[h!]
    ...
    \label{fig:terraform_apply_success_main}
\end{figure}
...
\begin{figure}[h!]
    ...
    \label{fig:terraform_state_list_main}
\end{figure}
...
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.85\textwidth]{images/aws_secrets_manager.png}
    \fbox{\parbox{0.85\textwidth}{\centering \vspace*{2cm} [Capture d'écran 5 : Console AWS Secrets Manager montrant le stockage sécurisé et le chiffrement du mot de passe RDS PostgreSQL] \vspace*{2cm}}}
    \caption{Stockage sécurisé du mot de passe d'administration SQL}
    \label{fig:aws_secrets_manager_main}
\end{figure}
