...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{images/structure_vscode.png}
    \caption{Structure de l'arborescence Terraform G5 vue depuis VS Code}
    \label{fig:structure_vscode}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{images/structure_du_projet_tree.png}
    \caption{Arborescence physique et organisation des répertoires du Lot 5 via terminal}
